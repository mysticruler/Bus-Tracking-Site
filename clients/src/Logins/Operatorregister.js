...
function Operatorregister() {
    ...
    return (
        <>
            <form method="post" onSubmit={addOpp}>
                        ...
                        <MDBCol col='12'>
                            ...
                            <MDBCard className='bg-dark text-white my-5 mx-auto' style={{ borderRadius: '1rem', maxWidth: '400px' }}>
                                <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto w-100'>
                                    ...
                                    <h2 className="fw-bold mb-2 text-uppercase">OPERATOR SIGNUP</h2>
                                    <p className="text-white-50 mb-5">Please Register Yourself</p>

                                    <MDBInput name="oppmail" onChange={(e) => setOppmail(e.target.value)} wrapperClass='mb-4 mx-5 w-100' labelClass='text-white' label='Enter Email address' id='formControlLg' type='email' size="lg" />
                                    ...
                                    <div class="wrap">
                                        <button class="button">REGISTER</button><Link to='/operatorlogin' ><button class="button">Go Back</button></Link>
                                    </div>
